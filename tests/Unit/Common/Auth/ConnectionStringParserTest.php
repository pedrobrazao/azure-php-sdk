...
final class ConnectionStringParserTest extends TestCase
{
    ...
    {
        return [
            ['', ConnectionStringParser::LOCAL_BLOB_ENDPOINT, ConnectionStringParser::LOCAL_QUEUE_ENDPOINT, ConnectionStringParser::LOCAL_TABLE_ENDPOINT],
            ['invalid entry', ConnectionStringParser::LOCAL_BLOB_ENDPOINT, ConnectionStringParser::LOCAL_QUEUE_ENDPOINT, ConnectionStringParser::LOCAL_TABLE_ENDPOINT],
            ...
            [
                'SharedAccessSignature=sv=2015-07-08&sig=iCvQmdZngZNW%2F4vw43j6%2BVz6fndHF5LI639QJba4r8o%3D&spr=https&st=2016-04-12T03%3A24%3A31Z&se=2016-04-13T03%3A29%3A31Z&srt=s&ss=bqt&sp=rwl',
    ...
    {
        return [
            [[], ConnectionStringParser::LOCAL_ACCOUNT_NAME],
    ...
    {
        return [
            [[], ConnectionStringParser::LOCAL_ACCOUNT_KEY],
